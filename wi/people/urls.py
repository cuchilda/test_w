...
urlpatterns = [
    ...
    path('students/generate/<int:n_students>/', views.generate_students, name='generator_students'),
    path('teachers/generate/<int:n_teachers>/', views.generate_teachers, name='generator_teachers'),
]